      ...
      >
        ...
        <div className={formPage.modalContent}>
          {formSubmit.code === 200 && (
            <>
              <div>
                Your form submission was a success! <span>&#127881;</span>
              </div>
              <div>
                You can now either update your form and send it again or you can return to the main page and choose to
                fill another survey if needed.
              </div>
            </>
          )}
          {formSubmit.code >= 400 && (
            <>
              ...
              <div>Here are the reported errors:</div>
